            ...
            <div class="modal-dialog modal-dialog-centered" role="document" >
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <!-- Table -->
                        <div>
                            <h2 style="color: darkblue"> <span class="icon-account_circle"></span></h2>
                            <table cellspacing="0" style="text-align: center;">
                                <tbody>
                                    ...
                                    <tr><td id="t"></td></tr>
                                    <tr><td id="t"></td></tr>
                                    <tr><td id="t"></td><a href="changedetails.php">Change Details</a></tr>
                                </tbody>
                            </table>
                        </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="brassclock.php" class="text-black h2 mb-0">Your Search Results..</a></h1>
          </div>
...
<?php
  $insearch=$_POST['insearch'];
      $search=mysqli_query($con,"SElECT * FROM items WHERE product LIKE'%$insearch%'") or mysqli_error("server error");
      if (empty($search)==true) 
      {
        echo "No Items found";
      }
      elseif(empty($search)==false)
      {
        echo "
            <h2>Search Items</h2>
            <table cellspacing='0'style='text-align:center'>
