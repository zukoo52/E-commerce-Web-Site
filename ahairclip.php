      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="ahairclip.php" class="text-black h2 mb-0">Hair Clip</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="aJewells.php">Jewells</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Hair Clip</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Hair Clip is believed to be used by Queen of King Rawana.</p>
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Its believed to be given by King Rawana at there wedding day.</p>
      ...
      <div class="container">
        ...
        <div class="row">  
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="ajewelrybox.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="anecklaceandsareeclip.php" class="media-1">
              <img src="images/Necklace and saree clip.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Necklace and Saree Clip</h2>
                <span class="category">Price <p style="color: red">Rs.140000<p></span>
              </div>
            </a>
          </div>

           <div class="col-md-6 col-lg-4 mb-4">
            <a href="agempendent.php" class="media-1">
