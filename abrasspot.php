      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="abrasspot.php" class="text-black h2 mb-0">Brass Pot</a></h1>
          </div>
          <div class="col-12 col-md-9 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="cart.php">Cart <span class="icon-shopping-cart"></span></a></li>
                <li>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="aMetalic.php">Metalic</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Brass Clock</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="images/brass pot.jpg" alt="Image" class="img-fluid">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Brass Pot is used in palace of Dutugamunu. </p>
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>It believed to be made by Mayadanawa.</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="abrassspear.php" class="media-1">
              <img src="images/brass spear.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Brass Spear</h2>
                <span class="category">Price <p style="color: red">Rs.8000<p></span>
              </div>
            </a>
          </div>

          <div class="col-md-6 col-lg-4 mb-4">
            <a href="abrasstable.php" class="media-1">
              <img src="images/brass table.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Brass Table</h2>
           ...
           <div class="col-md-6 col-lg-4 mb-4">
            <a href="achimineylamp.php" class="media-1">
              <img src="images/chimney lamp.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Chimney Lamp</h2>
                <span class="category">Price <p style="color: red">Rs.5000<p></span>
              </div>
            </a>
          </div>
