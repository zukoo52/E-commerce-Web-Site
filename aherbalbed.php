      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="aherbalbed.php" class="text-black h2 mb-0">Herbal Bed</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="aWooden.php">Wooden</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Herbal Bed</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Herbel Bed was used by Amara for curing his patients.</p>
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Stil some of illnesses can cure by this.Hove ever without knowing right medicines, we canot use this for cure vast illnesses.</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="amask.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="asecretboxes.php" class="media-1">
