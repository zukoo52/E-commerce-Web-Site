...
<!--     <meta charset="utf-8">
    ...
    <script type="text/javascript">
      function price()
      {
        var price = 140000-(140000*(25/100));
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="necklaceandsareeclip.php" class="text-black h2 mb-0">Necklace and Saree Clip</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Jewells.php">Jewells</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Necklace and Saree Clip</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="images/Necklace and saree clip.jpg" alt="Image" class="img-fluid">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <div class="mb-3">
              <a href="Wooden.php">
                <span class="badge purple mr-1" style="background-color: blue;color: white">Category Jewells</span>
              </a>
            </div>

            <p class="lead">
              <span class="mr-1">
                Rs.<del id="de">140000</del>
              </span>
              Rs.<span id="sp"></span>
            </p>
            ...
            <p>This Jewelry Box is believed to be used by Mistress of Gongalegoda Banda.</p>
  ...
  if(isset($_POST['addcart']))
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Gongalegoda Banda was one of the freedom fighter against Engaland.</p>
      ...
      <div class="container">
        <center><h3 style="color: blue">Interest in some More</h3></center>
        <br>
        <div class="row">

        <div class="col-md-6 col-lg-4 mb-4">
            <a href="jewelrybox.php" class="media-1">
              <img src="images/jewelry box.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Jewelry Box</h2>
                <span class="category">Price <p style="color: red">Rs.30000<p></span>
              </div>
            </a>
          </div>  

           <div class="col-md-6 col-lg-4 mb-4">
            <a href="gempendent.php" class="media-1">
              <img src="images/gem pendent.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Gem Pendent</h2>
                <span class="category">Price <p style="color: red">Rs.100000<p></span>
              </div>
            </a>
          </div>

          <div class="col-md-6 col-lg-4 mb-4">
            <a href="hairclip.php" class="media-1">
              <img src="images/hair clip.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Hair Clip</h2>
                <span class="category">Price <p style="color: red">Rs.40000<p></span>
              </div>
            </a>
          </div> 
