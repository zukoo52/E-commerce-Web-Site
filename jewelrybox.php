      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="jewelrybox.php" class="text-black h2 mb-0">Jewelry Box</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Jewelry Box</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Jewelry Box is believed to be used by princess Suparnika.</p>
  ...
  if(isset($_POST['addcart']))
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>princess Suparnika is the sister of King Rawana.</p>
