                ...
                <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <div class="row form-group">
                            <div class="col-md-12">
                              <input type="submit" value="SignIn" name="SignInm" class="btn btn-primary btn-md text-white">
                            </div>
                          </div>
                      </form>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="gMetalic.php" class="text-black h2 mb-0">Metalic</a></h1>
          </div>
