...
<!--     <meta charset="utf-8">
    ...
    <script type="text/javascript">
      function price()
      {
        var price = 100000-(100000*(25/100));
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="gempendent.php" class="text-black h2 mb-0">Gem Pendent</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gem Pendant</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Gem Pendent is believed to be used by princess Seetha.</p>
  ...
  if(isset($_POST['addcart']))
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Seetha is doughter of king Rawana.</p>
