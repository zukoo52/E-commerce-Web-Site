      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php" class="text-black h2 mb-0">Metalic</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Metalic</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="brassclock.php" class="media-1">
              <img src="images/brass clock.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="brasspot.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="brassspear.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="brasstable.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="chimineylamp.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="cutter.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="hanginglamp.php" class="media-1">
