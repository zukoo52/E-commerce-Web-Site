                ...
                <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <div class="row form-group">
                            <div class="col-md-12">
                              <input type="submit" value="SignIn" name="SignInj" class="btn btn-primary btn-md text-white">
                            </div>
                          </div>
                      </form>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="gJewells.php" class="text-black h2 mb-0">Jewells</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Jewells</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 ml-auto">
                ...
                <ul class="list-unstyled">
                  <li><a href="gabout.php">About Us</a></li>
                  <li><a href="gCategories.php">Categories</a></li>
                  <li><a href="gcontact.php">Contact Us</a></li>
                </ul>
              </div>
              <div class="col-md-3">
