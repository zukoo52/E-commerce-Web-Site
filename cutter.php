      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="cutter.php" class="text-black h2 mb-0">Cutter</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cutter</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This Cutter was used by Barana.</p>
  ...
  if(isset($_POST['addcart']))
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Barana is one of the 10 giants of king Dutugamunu.</p>
