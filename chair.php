      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="chair.php" class="text-black h2 mb-0">Chair</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Cerimic.php">Wooden</a></li>
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This chair has found from isurumuniya.Its belevied to be used by Wishrawas Muni.</p>
  ...
  if(isset($_POST['addcart']))
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Some say its have some medical power because it was made by Maya Danawa and Amara for Wishrawas Muni.</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="herbalbed.php" class="media-1">
              <img src="images/Herbal bed.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="mask.php" class="media-1">
              <img src="images/Mask.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Mask</h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="octagontable.php" class="media-1">
