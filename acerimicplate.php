      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-3">
            <h1 class="mb-0 site-logo"><a href="acerimicplate.php" class="text-black h2 mb-0">Cerimic Plate</a></h1>
          </div>
                    ...
                    <div class="breadcumb--con">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cerimic Plate</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <div class="mb-3">
              <a href="aCerimic.php">
                <span class="badge purple mr-1" style="background-color: orange;color: white">Category Cerimic</span>
              </a>
            </div>
            ...
            <p>This Cerimic Plate is also believed to be used by queen Elecebath.</p>
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Its used when she arrived Sri Lanka during her rule age..</p>
      ...
      <div class="container">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <a href="acerimicball.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="acerimicplate.php" class="media-1">
              <img src="images/Ceremic Plate.jpg" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Ceremic Plate</h2>
